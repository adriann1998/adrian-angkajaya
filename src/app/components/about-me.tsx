          ...
          <div className="grid grid-cols-2 gap-6">
            <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                <h3 className="text-4xl font-bold text-purple-400 mb-2">{projectCounter}{projectCounter === totalProjects ? '+' : ''}</h3>
                <p className="text-xl text-gray-300">Projects Completed</p>
              </CardContent>
            </Card>
            <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <CardContent className="p-6 text-center">
                <h3 className="text-4xl font-bold text-purple-400 mb-2">{yoeCounter}{yoeCounter === totalYoe ? '+' : ''}</h3>
